namespace Sortable_Collection.Tests
{
    ...
    public class SortTests
    {
        ...
        {
            var emptyCollection = new SortableCollection();
        ...
        {
            var collection = new SortableCollection(1);
        ...
        {
            var collection = new SortableCollection(1, -5);
            collection.Sort(TestSorter);
        ...
        {
            var collection = new SortableCollection(3, 44, 38, 5, 47, 15, 36, 26, 27, 2, 46, 4, 19, 50, 48);
